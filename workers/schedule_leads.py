...
dag = DAG('leads_http_operator', default_args=default_args, tags=['purchase order'], start_date=days_ago(2))
...
task_post_op = SimpleHttpOperator(
    task_id='post_op',
    endpoint='https://stateset.network:8080/api/stateset/createLeads',
